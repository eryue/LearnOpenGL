...
int main()
{
	...
	Shader shader("../LearnOpenGL/StencilTesting/advanced.vs", "../LearnOpenGL/StencilTesting/advanced.frag");
	Shader shaderSingleColor("../LearnOpenGL/StencilTesting/advanced.vs", "../LearnOpenGL/StencilTesting/single_color.frag");
...
#pragma region "object_initialization"
	...
	// Load textures
	GLuint cubeTexture = loadTexture("../LearnOpenGL/StencilTesting/container2.png");
