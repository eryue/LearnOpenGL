...
int main()
{
	...
	Shader planetShader("../LearnOpenGL/Instancing/advanced.vs", "../LearnOpenGL/Instancing/advanced.frag");
	Shader instanceShader("../LearnOpenGL/Instancing/instancing.vs", "../LearnOpenGL/Instancing/instancing.frag");
