...
int main()
{
	...
	Shader shaderRed("../LearnOpenGL/Uniformbuffer/ubo.vs", "../LearnOpenGL/Uniformbuffer/ubo_red.frag");
	Shader shaderGreen("../LearnOpenGL/Uniformbuffer/ubo.vs", "../LearnOpenGL/Uniformbuffer/ubo_green.frag");
	Shader shaderBlue("../LearnOpenGL/Uniformbuffer/ubo.vs", "../LearnOpenGL/Uniformbuffer/ubo_blue.frag");
	Shader shaderYellow("../LearnOpenGL/Uniformbuffer/ubo.vs", "../LearnOpenGL/Uniformbuffer/ubo_yellow.frag");
