...
int main()
{
	...
	Shader lightingShader("../LearnOpenGL/Material/lighting.vs", "../LearnOpenGL/Material/lighting.frag");
	Shader lampShader("../LearnOpenGL/Material/lamp.vs", "../LearnOpenGL/Material/lamp.frag");
