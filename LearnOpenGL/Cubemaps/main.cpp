...
int main()
{
	...
	Shader shader("../LearnOpenGL/Cubemaps/advanced.vs", "../LearnOpenGL/Cubemaps/advanced.frag");
	Shader skyboxShader("../LearnOpenGL/Cubemaps/skybox.vs", "../LearnOpenGL/Cubemaps/skybox.frag");
