...
int main()
{
	...
	Shader lightingShader("../LearnOpenGL/LightingCasters/lighting.vs", "../LearnOpenGL/LightingCasters/lighting.frag");
	Shader lampShader("../LearnOpenGL/LightingCasters/lamp.vs", "../LearnOpenGL/LightingCasters/lamp.frag");
	...
	unsigned char* image;
	// Diffuse map
	image = SOIL_load_image("../LearnOpenGL/LightingCasters/container2.png", &width, &height, 0, SOIL_LOAD_RGB);
	...
	// Specular map
	image = SOIL_load_image("../LearnOpenGL/LightingCasters/container2_specular.png", &width, &height, 0, SOIL_LOAD_RGB);
